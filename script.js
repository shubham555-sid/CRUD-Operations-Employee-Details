...
function highlightIndexBtn() {
    let startIndex = ((currentIndex - 1) * tableSize) + 1;
    let endIndex = (startIndex + tableSize) - 1;
...
function showInfo() {
    ...
    var tab_start = (currentIndex - 1) * tableSize;
    var tab_end = Math.min(tab_start + tableSize, getData.length);
            ...
            if (staff) {
                let createElement = `<tr class="employeeDetails">
                    ...
                    <td>
                        ...
                        <button onclick="deleteInfo(${i})"><i class="fa-light fa-trash-can"></i></button>
                    </td>
                </tr>`
...
filterData.addEventListener("input", () => {
    ...
    if (searchTerm !== "") {
        ...
        const filteredData = originalData.filter((item) => {
            ...
            const email = item.emailVal.toLowerCase()
